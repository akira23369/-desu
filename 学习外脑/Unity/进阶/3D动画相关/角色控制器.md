...
//注意：
//添加角色控制器后，不用再添加刚体
//能检测碰撞函数   (只有别人可以通过OnCollisionEnter可以检测,  自己是通过OnControllerColliderHit)
//能检测触发器函数
//能被射线检测
#endregion
...
![[Pasted image 20240713215355.png]]


ps: 使用了角色控制器可以把角色上Animator组件的 使用动画位移(Apply Root Motion)给关了
